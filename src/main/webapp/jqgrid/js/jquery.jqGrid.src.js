...
//									+ "</div>").insertBefore(gv);
					...
					var sortkeys = [ "shiftKey", "altKey", "ctrlKey" ], intNum = function(
						...
						var tabindex = '-1', restAttr = '', attrName, style = hide ? 'display:none;'
								: '', classes = 'ui-widget-content jqgrow ui-row-'
								+ ts.p.direction
								+ altClass
						...
						$("span.ui-icon-" + ts.p.sortorder, newSelectedTh)
								.removeClass('ui-state-disabled');
							...
							.each(function() {
								...
								var toggleToolbar = function() {
									var trow = $("tr.ui-search-toolbar",
											$t.grid.hDiv), trow2 = $t.p.frozenColumns === true ? $(
								...
								$
										.each(
												...
												function() {
													...
													th = $("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"
															+ $t.p.direction
															+ "'></th>");
													...
													if (this.search) {
														...
														case "select":
															...
															if (surl) {
																...
																var oSv, sep, delim;
																if (cm.searchoptions) {
																	oSv = cm.searchoptions.value === undefined ? ""
																			: cm.searchoptions.value;
																	sep = cm.searchoptions.separator === undefined ? ":"
																			: cm.searchoptions.separator;
																	delim = cm.searchoptions.delimiter === undefined ? ";"
																			: cm.searchoptions.delimiter;
																} else if (cm.editoptions) {
																	oSv = cm.editoptions.value === undefined ? ""
																			: cm.editoptions.value;
																	sep = cm.editoptions.separator === undefined ? ":"
																			: cm.editoptions.separator;
																	delim = cm.editoptions.delimiter === undefined ? ";"
																			: cm.editoptions.delimiter;
																}
																if (oSv) {
																	var elem = document
...
(function($) {
	...
	$.fn.fmatter.actions = function(cellval, opts) {
		...
		str += "<div title='"
				...
				+ ocl + "><span class='ui-icon ui-icon-disk'></span></div>";
		...
		str += "<div title='"
				...
				+ ocl + "><span class='ui-icon ui-icon-cancel'></span></div>";
...
$.extend($.jgrid,{
						...
						info_dialog : function(caption, content, c_b, modalopt) {
							...
							cnt += "<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:"
									+ dh + ";" + cn + "'>" + content + "</div>";
							cnt += c_b ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:"
									+ mopt.buttonalign
									...
									+ c_b + "</a>" + buttstr + "</div>"
									: buttstr !== "" ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:"
											+ mopt.buttonalign
 ...
 * example of a filter:
 *  { "groupOp": "AND", "groups" : [ { "groupOp": "OR", "rules": [ { "field":
 * "name", "op": "eq", "data": "England" }, { "field": "id", "op": "le", "data":
 * "5"} ] } ], "rules": [ { "field": "name", "op": "eq", "data": "Romania" }, {
							...
							.each(function() {
								...
								if ($("#" + $.jgrid.jqID(IDs.themodal))[0] !== undefined) {
									...
									var bP = "<a href='javascript:void(0)' id='"
											...
											+ bn
											+ "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>", bS = "<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>"
									...
									p.saveicon = $.extend([ true, "left",
											"ui-icon-disk" ], p.saveicon);
									p.closeicon = $.extend([ true, "left",
											"ui-icon-close" ], p.closeicon);
				...
				viewGridRow : function(rowid, p) {
					...
					return this
							.each(function() {
								...
								function createData(rowid, obj, tb, maxcols) {
									var nm, hc, trdata, cnt = 0, tmp, dc, retpos = [], ind = false, i, tdtmpl = "<td class='CaptionTD form-view-label ui-widget-content' width='"
											+ p.labelswidth
											+ "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", tmpl = "", tdtmpl2 = "<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>", fmtnum = [
										...
										.each(
												...
												function(i, n) {
													...
													clid = $t.p.id + "ghead_"
															+ n.idx;
													hid = clid + "_" + i;
													icon = "<span style='cursor:pointer;' class='ui-icon "
															+ pmrtl
															+ "' onclick=\"jQuery('#"
															+ $.jgrid
																	.jqID($t.p.id)
